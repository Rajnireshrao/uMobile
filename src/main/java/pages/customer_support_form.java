...
public Menu_Options  Submit_a_form_with_Null_Issue_Type() throws Exception {
		...
		A3.click();
		System.out.println("Submit button is clicked");
		String ErrorMessage = driver.findElement(By.xpath("hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.widget.TextView[2]")).getText();
		System.out.println("Error Message is "+ErrorMessage);
		return new Menu_Options();
	}

public Menu_Options  Submit_a_form_with_Null_feedback() throws Exception {
